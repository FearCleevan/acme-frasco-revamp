...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden">
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 anim-fade d700 hidden md:flex flex-col items-center gap-2">
      ...
      <div className="relative flex items-start justify-between max-w-7xl mx-auto px-4 sm:px-6 w-full pt-20 pb-20 md:pt-24 md:pb-24">
        ...
        {/* Card */}
        <div className="bg-white/95 backdrop-blur-lg border-l-4 border-orange px-5 pt-6 pb-5 sm:px-8 sm:pt-8 sm:pb-6 md:px-12 md:pt-10 md:pb-8 max-w-[640px] w-full shadow-heavy anim-up d200 self-start">
          <div className="space-y-5 sm:space-y-6">
            ...
            <div className="flex flex-col gap-4 sm:gap-5">
              <p className="text-ink/70 text-sm sm:text-[15px] leading-relaxed opacity-0 anim-fade d500">
                Certified personnel. On-site. Same-day results. Available 24/7
                across Nova Scotia, New Brunswick, Newfoundland and beyond.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 opacity-0 anim-fade d700">
                <Link
                  href="/contact"
        ...
        <div className="ml-8 shrink-0 hidden lg:block anim-fade d300 self-start">
